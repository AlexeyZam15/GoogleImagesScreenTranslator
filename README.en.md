...
📋 **Translation queue** — select multiple areas in a row (F3) without waiting for the current translation to finish; all tasks are processed sequentially in a queue, and results are displayed immediately after each translation completes  
...
- **F3 (area selection)** — takes a screenshot of the entire screen, allows you to select any area with the mouse. You
  can select multiple areas in a row without waiting for the previous translation to finish — they will all be added to
  a queue and translated sequentially. Old overlays remain visible
...
- **📋 Translation queue** — select multiple areas in a row (F3) without waiting for the current translation to finish;
  all tasks are processed sequentially in a queue, and results are displayed immediately after each translation
  completes
